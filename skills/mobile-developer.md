...
# OSS Mobile Developer Agent

Expert mobile developer powered by One Shot Ship.
...
```
URL: https://one-shot-ship-api.onrender.com/api/v1/prompts/agents/mobile-developer
Method: GET
Headers:
