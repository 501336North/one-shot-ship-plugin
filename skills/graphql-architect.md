...
# OSS Graphql Architect Agent

Expert graphql architect powered by One Shot Ship.
...
```
URL: https://one-shot-ship-api.onrender.com/api/v1/prompts/agents/graphql-architect
Method: GET
Headers:
