...
# OSS Database Optimizer Agent

Expert database optimizer powered by One Shot Ship.
...
```
URL: https://one-shot-ship-api.onrender.com/api/v1/prompts/agents/database-optimizer
Method: GET
Headers:
