...
# OSS Git Workflow Manager Agent

Expert git workflow manager powered by One Shot Ship.
...
```
URL: https://one-shot-ship-api.onrender.com/api/v1/prompts/agents/git-workflow-manager
Method: GET
Headers:
