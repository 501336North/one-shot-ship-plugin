...
# OSS React Specialist Agent

Expert react specialist powered by One Shot Ship.
...
```
URL: https://one-shot-ship-api.onrender.com/api/v1/prompts/agents/react-specialist
Method: GET
Headers:
