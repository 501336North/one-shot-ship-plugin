...
# OSS Performance Auditor Agent

Expert performance auditor powered by One Shot Ship.
...
```
URL: https://one-shot-ship-api.onrender.com/api/v1/prompts/agents/performance-auditor
Method: GET
Headers:
