...
# OSS Deployment Engineer Agent

Expert deployment engineer powered by One Shot Ship.
...
```
URL: https://one-shot-ship-api.onrender.com/api/v1/prompts/agents/deployment-engineer
Method: GET
Headers:
