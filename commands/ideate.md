---
description: Gather context, explore ideas, and brainstorm through Socratic questioning
allowed-tools: Bash, Read, Write, Edit, Grep, Glob, AskUserQuestion, TodoWrite
---

# One Shot Ship: ideate
...
```bash
node ~/.claude/plugins/cache/oss/lib/decrypt.js ideate
```
