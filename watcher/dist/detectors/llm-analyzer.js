...
export class LLMAnalyzer {
    ...
    confidenceThreshold;
    apiUrl;
    constructor(queueManager, ruleEngine, apiKey, confidenceThreshold = 0.7, apiUrl = 'https://one-shot-ship-api.onrender.com/api/v1/analyze') {
     ...
     */
    async analyzeAndReport(logContent) {
