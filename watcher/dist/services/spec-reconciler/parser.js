 ...
 */
export function parseSpecItem(line, type) {
 ...
 */
function generateBehaviorId(description) {
 ...
 */
function getItemTypeForMarker(marker) {
    switch (marker) {
        case 'components':
            return 'component';
        case 'criteria':
 ...
 */
export function parseSpecSection(content, marker) {
 ...
 */
export function parseSpecFile(content, featureName) {
