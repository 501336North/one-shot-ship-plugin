...
export class BuildPreflightService {
    ...
    reconciler;
    basePath;
    constructor(specMonitor, reconciler, basePath) {
     ...
     */
    async runPreflightCheck(feature) {
     ...
     */
    async handleUserChoice(choice, report) {
        switch (choice) {
            case 'fix':
    ...
    async handleFix(report) {
        ...
        const reconcileReport = await this.reconciler.reconcile(report.drifts, report.feature, report.specPath, searchPaths);
        return {
            action: 'fix',
            success: true,
...
//# sourceMappingURL=build-preflight.js.map