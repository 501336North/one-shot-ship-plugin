 ...
 */
export async function loadGlobalConfig(): Promise<AgentsConfig> {
 ...
 */
export async function loadProjectConfig(): Promise<AgentsConfig> {
...
export function mergeConfigs(
  ...
  const merged: AgentsConfig = { agents: {} };
