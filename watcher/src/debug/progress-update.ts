 ...
 */
export function appendFixTasks(existingContent: string, tasks: FixTask[]): string {
 ...
 */
export function createProgressContent(tasks: FixTask[], featureName: string): string {
