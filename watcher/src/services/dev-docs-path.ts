 ...
 */
export function getDevDocsPath(projectDir: string): string {
 ...
 */
export function getActiveFeaturePath(projectDir: string, featureName: string): string {
 ...
 */
export function getCompletedPath(projectDir: string): string {
  const devDocsPath = getDevDocsPath(projectDir);
