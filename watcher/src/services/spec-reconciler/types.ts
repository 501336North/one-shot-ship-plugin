...
export type DriftType =
  | 'structural_missing' // Component in spec but not in code
  | 'structural_extra' // Component in code but not in spec
  | 'behavioral_mismatch' // Behavior differs from spec
  | 'criteria_incomplete'; // Acceptance criteria not fully implemented
