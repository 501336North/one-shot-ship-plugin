...
export class Watcher {
   ...
   */
  private async initializeWebhookReceiver(): Promise<void> {
    ...
    try {
      ...
      if (this.queueManager) {
        this.webhookReceiver.onEvent((payload) => {
          ...
          const review = eventPayload.review as Record<string, unknown> | undefined;
          const reviewState = review?.state as string | undefined;
