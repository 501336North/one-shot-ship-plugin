---
name: python-pro
description: Python expert. Use for Python development, data science, and backend Python applications.
model_routing: true
---
...
```
URL: https://one-shot-ship-api.onrender.com/api/v1/prompts/agents/python-pro
Method: GET
Headers:
